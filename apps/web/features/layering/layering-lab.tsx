...
export function LayeringLab({ initialA }: { initialA?: string }) {
  ...
  return (
    <section className="page">
      ...
      <PreviewNotice>Layering guidance is a preview built on sample data. Combinations are not saved to your account.</PreviewNotice>
